...
import shotline from '../../assets/images/golf-stock-img.jpg'
            ...
            <div className='project-grid' >
                <div className='row'>
                    <div className='sub_row'>
                        <AnimatedProject imgPath={shotline} link={'https://04mscott.github.io/Shotline-Golf-Analytics//'} title={'Shotline - Golf Analytics Platform (in development)'} langs={'Python, SQL'} tools={'Flask, PostgreSQL, Pandas, Numpy, Docker'} />
